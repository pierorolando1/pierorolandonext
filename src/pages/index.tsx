...
export default function Home() {
  return (
    <>
      ...
      <main className="text-gray-50 bg-gray-950 h-screen w-full p-12">
        ...
        <div className="px-4 py-2 flex w-full bg-gray-900/60 rounded-xl cursor-text max-w-md items-center hover:bg-gray-900/90 transition-all">
